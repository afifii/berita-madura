...
?>
<!-- footer start -->
<footer class="footer footer-bg <?php if(is_active_sidebar( 'footer-1' ) || is_active_sidebar( 'footer-2' ) || is_active_sidebar( 'footer-3' ) || is_active_sidebar( 'footer-4' )){echo esc_attr('pt-110');}?>">
    <div class="container">
