<?php
/**
 * glox Bootstrap Navwalker
 *
 * @package glox-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if ( ! class_exists( 'Magezix_Bootstrap_Navwalker' ) ) {
	/**
	 * Magezix_Bootstrap_Navwalker class.
	 */
	class Magezix_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'magezix' ) . '">' . esc_html__( 'Add a menu', 'magezix' ) . '</a></li>';
			$fallback_output .= '</ul>';
